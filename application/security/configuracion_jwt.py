...
#from security_models import User, UserInDB, Token, TokenData
...
fake_users_db = {
    "johndoe": {
        ...
        "persona_id": "21",
        "contrasenia": "$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW",
...
def get_user(user_list, username: str):
    if username in user_list:
        user_dict = user_list[username]
        return UserInDB(**user_dict)


def authenticate_user(user_list, username: str, password: str):
...
async def get_current_active_user(
    ...
    if current_user.borrado_logico:
